        ...
        <div className="founder-profile-grid">
          <div className="founder-photo-section">
            <div className="founder-image-wrapper glass-panel">
              <img src={founderImg} alt="Shivdeep Roy" className="founder-img-file" />
            </div>
          ...
          <div className="founder-info-section">
            ...
            <h1 className="founder-display-name">Shivdeep Roy</h1>
            ...
            <div className="founder-detailed-bio">
              ...
              <p>
                Shivdeep Roy is a seasoned space curator who bridges the gap between artistic installations and strategic marketing. With over a decade of hands-on expertise in architectural design, material science, and expo fabrication, he oversees every design layout created at Pinwheelent.
              </p>
              <p>
